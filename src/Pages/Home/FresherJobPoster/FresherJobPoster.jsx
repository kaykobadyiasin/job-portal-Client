        ...
        fetch('https://job-portal-server-gamma.vercel.app/fresherJobs', {
            ...
            .then(data => {
                ...
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: 'Fresher Job Added Success',
        ...
        <div className="hero-content my-20 flex-col lg:flex-row-reverse text-center  container mx-auto">
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                    <h2 className='mx-auto border-b-4 lg:w-full py-3 rounded w-full text-3xl text-center border-[#60A5FA] font-semibold'>Fresher Job</h2>
...
export default FresherJobPoster;